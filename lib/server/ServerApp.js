        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_r) {
                switch (_r.label) {
                    ...
                    case 1:
                        _r.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, mongoose.connect(this.config.mongoUris, __assign({ useNewUrlParser: true }, this.config.mongooseConnectionOptions))];
                    case 2:
                        _r.sent();
                    ...
                    case 13:
                        ...
                        if (this.config.publicDirs) {
                            for (_f = 0, _g = this.config.publicDirs; _f < _g.length; _f++) {
                                dir = _g[_f];
                                this.app.use(KoaStaticCache(dir, __assign({ cacheControl: this.config.cacheControl || 'private' }, this.config.cacheOptions), this.config.cacheFiles));
